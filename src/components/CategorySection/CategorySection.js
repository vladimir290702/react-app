    ...
    return (
        <div className="category_container">
            <section className="category_text">
                <h2 className="category_notification">You can chose between Netflix movies or movies added by our users!</h2>
                ...
                <p>In this application you can find the information you need about your favourite movie or 
                    ...
                    places. The first one is the movie giant - Netflix, where you can watch movies and TV 
                    series with top quality and we have granted you the information in an easy way. The second 
                ...
                <ol>
                    ...
                    <li>If you can't find your favourite movie, you can add it by yourself!</li>
                </ol>
